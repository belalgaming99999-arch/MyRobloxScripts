-- [[ Crystal Hub - Professional Injection Mode ]] --

-- 1. وظيفة الانتظار لضمان تحميل اللعبة بالكامل قبل الحقن
...
-- 2. نظام التنظيف الذكي (لإعادة التشغيل بدون مشاكل)
local UI_NAME = "Crystal_Final_Pro_Injection"
...
-- 3. إنشاء الواجهة مع دعم الـ CoreGui (لأمان النسخ)
...
-- محاولة الحقن في CoreGui أولاً (طريقة النسخ) وإذا فشلت تذهب لـ PlayerGui
...
-- [[ اللوحات العلوية والسفلية - حواف ناعمة ]] --
...
local function CreateBtn(txt, parent, size)
    ...
    btn.Size = size or UDim2.new(0, 140, 0, 38)
    btn.BackgroundColor3 = RightPartColor; btn.BackgroundTransparency = RightPartTrans
