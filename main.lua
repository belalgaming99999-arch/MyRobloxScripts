-- [[ Crystal Hub - Buttons Border Edition ]] --
...
local function DeepCleanup()
    local names = {"Crystal_Final_Safe", "Crystal_Compact_Visual", "Crystal_Purple_Borders", "Crystal_Unified_Final", "Crystal_Smooth_Final", "Crystal_Buttons_Borders"}
...
local UI_NAME = "Crystal_Buttons_Borders"
...
local function CreateBtn(txt, parent, size)
    ...
    -- حواف الزر (إطار بنفسجي حول كل زر)
    local s = Instance.new("UIStroke", btn)
    s.Color = CrystalPurple
    s.Thickness = 1.5 -- سمك الحواف حول الزر
