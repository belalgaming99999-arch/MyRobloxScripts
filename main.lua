-- [[ Crystal Hub - Final Purple Borders Edition ]] --
...
-- [[ إعدادات الألوان (البنفسجي الموحد المطابق للخط) ]] --
...
local UI_NAME = "Crystal_Final_Visual"
...
-- [[ اللوحة العلوية والسفلية - إطارات بنفسجية موحدة ]] --
...
-- إضافة الإطار البنفسجي الموحد
local TopStroke = Instance.new("UIStroke", TopBar)
TopStroke.Color = CrystalPurple; TopStroke.Thickness = 2 -- نفس سمك الخط
...
-- [[ المنيو الجانبي - إطار بنفسجي موحد ]] --
...
SideStroke.Color = CrystalPurple; SideStroke.Thickness = 2 -- مطابق تماماً للوحة العلوية
...
local function CreateBtn(txt, parent, size)
    ...
    -- إطارات الأزرار بنفسجية أيضاً ولكن أنحف قليلاً للجمال
