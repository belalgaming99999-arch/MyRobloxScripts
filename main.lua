-- [[ Crystal Hub - Standardized White Text & Fixed HUD ]] --
...
ScreenGui.Name = "Crystal_Symmetry_UI"

-- ========== 1. Top HUD (إرجاع القائمة السفلية) ==========
...
SaveBtn.Size = UDim2.new(0, 150, 0, 28); SaveBtn.Position = UDim2.new(0.5, -75, 0, 214) 
