...
local ScreenName = "CrystalHubSharp"
...
-- // زر الفتح (أبيض سادة وحواف دقيقة)
...
OpenBtn.TextStrokeTransparency = 1 -- إلغاء التوهج تماماً
...
Main.Name = "Main"
Main.Size = UDim2.new(0, 380, 0, 185)
Main.Position = UDim2.new(0.5, -190, 0.5, -92)
...
local function CreateToggle(name, pos, icon, var)
    ...
    L.Size, L.Position, L.Text = UDim2.new(0, 80, 1, 0), UDim2.new(0, 45, 0, 0), name -- مسافة 9 بيكسل (45-36)
...
SF.Size, SF.Position, SF.BackgroundColor3 = UDim2.new(1, 0, 0, 68), UDim2.new(0, 0, 1, -68), Color3.fromRGB(35, 35, 35)
...
CombinedLabel.Position = UDim2.new(0, 0, 0, 8)
...
-- // إنشاء الأسهم بمسافة مطابقة للأيقونات العلوية (9 بيكسل من شريط السلايدر)
...
-- تم رفع السلايدر "سنة" (من 46 إلى 45) وضبط المسافة 9 بيكسل للأسهم
local SBtn = Instance.new("Frame", SF)
SBtn.Size, SBtn.Position, SBtn.BackgroundColor3 = UDim2.new(0, 240, 0, 6), UDim2.new(0.5, -120, 0, 45), Color3.fromRGB(60, 60, 60)
...
-- الأسهم بمسافة 9 بيكسل دقيقة من السلايدر
CreateArr("<", UDim2.new(0, 33, 0, 34), -1) -- 120-33-28 = 59 مسافة دقيقة
CreateArr(">", UDim2.new(1, -61, 0, 34), 1)
...
-- زر إغلاق مخفي في الهيدر (اختياري) أو يمكنك إضافة زر X
