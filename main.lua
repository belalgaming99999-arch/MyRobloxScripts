...
local function CreateToggle(name, pos, icon, var)
    ...
    B.MouseButton1Click:Connect(function()
        ...
        TS:Create(Dot, TweenInfo.new(0.2), {Position = act and UDim2.new(1, -15, 0.5, -6.5) or UDim2.new(0, 2, 0.5, -6.5)}):Play()
    end)
end
...
local L_Arr, R_Arr = CreateArr("<", UDim2.new(0, 20, 0, 45)), CreateArr(">", UDim2.new(1, -50, 0, 45))
...
local function ToggleUI(s)
    if s then
        ...
        task.wait(0.2) Main.Visible, OpenBtn.Visible = true, true
    end
end
