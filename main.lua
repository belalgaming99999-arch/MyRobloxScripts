...
local function CreateSpeedTag(char)
    ...
    if head:FindFirstChild("SpeedTag") then head.SpeedTag:Destroy() end
...
SideButton.Size = UDim2.new(0, 50, 0, 50); SideButton.Position = UDim2.new(1, -65, 0.20, 0)
