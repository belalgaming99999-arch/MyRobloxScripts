-- [[ Crystal Hub - Perfect Symmetry Edit ]] --
...
-- ========== 3. Main Side Menu (Symmetry Adjustment) ==========
...
local function StyleButton(btn, thick)
    ...
    btn.MouseButton1Click:Connect(function()
        if btn.Name ~= "SaveBtn" then
            btn.BackgroundColor3 = (btn.BackgroundColor3 == DarkColor) and CrystalPurple or DarkColor
            btn.BackgroundTransparency = (btn.BackgroundColor3 == CrystalPurple) and 0 or 0.3
        end
    end)
end

-- المسافة العلوية (Player Esp)
...
-- زر Save Config (التعديل هنا لضبط التماثل تماماً)
local SaveBtn = Instance.new("TextButton", MainMenu)
SaveBtn.Name = "SaveBtn"
SaveBtn.Size = UDim2.new(0, 150, 0, 28); 
-- وضعناه في Position يضمن أن الفراغ فوقه يساوي الفراغ تحت Player Esp
SaveBtn.Position = UDim2.new(0.5, -75, 0, 214); 
SaveBtn.BackgroundColor3 = DarkColor; SaveBtn.BackgroundTransparency = 0.3; SaveBtn.ZIndex = 5
SaveBtn.TextColor3 = Color3.fromRGB(255, 255, 255); SaveBtn.Text = "Save Config"; SaveBtn.Font = Enum.Font.GothamBold; SaveBtn.TextSize = 10
